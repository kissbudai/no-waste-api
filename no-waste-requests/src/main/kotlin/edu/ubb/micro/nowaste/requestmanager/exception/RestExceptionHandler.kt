...
class RestExceptionHandler {
	...
	fun handleNotAllowedException(response: HttpServletResponse, exception: NotAllowedException): NoWasteErrorResponse =
		NoWasteErrorResponse(403, "This action is not allowed for you", exception.message)
